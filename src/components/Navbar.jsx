...
const Navbar = () => {
  ...
  const { userEmail, logout, userDept, userName } = useAuth(); // Assuming you have a user object in AuthContext
        ...
        <div className="relative">
          ...
          {isDropdownOpen && (
            <div className="absolute right-0 mt-2 w-auto max-w-xs bg-white shadow-lg rounded-lg">
              ...
              <p className="text-sm overflow-hidden text-ellipsis whitespace-nowrap">{userName}</p>
