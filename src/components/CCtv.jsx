...
const CCTV = () => {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-gray-900 to-blue-900 p-8">
      <Sidebar /> {/* Add Sidebar here */}
      <div className="flex-1 ml-60"> {/* Adjust this margin based on your sidebar width */}
